...
--keydown */
class Cubo {
    constructor(areaMovimientoElement, cuboElement, velocidadDeMovimiento) {
...
const areaMovimiento = document.getElementById('area-movimiento');
const cuboElemento = document.getElementById('cubo');
